...
urlpatterns = [
    ...
    path("results/<int:session_id><str:display_mri>/run_predictions/", result_helper_views.run_prediction, name="run_predictions"),
    path("results/<int:session_id><str:display_mri>/run_segmentation/", result_helper_views.run_segmentation, name="run_segmentation"),
