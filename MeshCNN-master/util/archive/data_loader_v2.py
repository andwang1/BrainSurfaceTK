...
class OurDataset(InMemoryDataset):
    def __init__(self, root, label_class='gender', classification=True, train=True, transform=None,
        ...
        if data_folder is None:
            self.data_folder = "/vol/biomedic/users/aa16914/shared/data/dhcp_neonatal_brain/surface_fsavg32k/reduced_90/vtk/pial"
        else:
    ...
    def get_file_path(self, patient_id, session_id, extension='vtp'):
        ...
        file_name = "sub-" + patient_id +"_ses-" + session_id + "_hemi-L_pial_reduce90.vtk"
