...
def convert_to_vtp(path, new_path):
...
if __name__ == "__main__":
    # path = "/mnt/UHDD/Programming/Projects/DeepLearningOnBrains/models/gNNs/data"
    path = "/vol/biomedic/users/aa16914/shared/data/dhcp_neonatal_brain/surface_native/reduced_20k/white"
    # new_path = "/mnt/UHDD/Programming/Projects/DeepLearningOnBrains/models/gNNs/tmp_data"
    new_path = "/vol/bitbucket/cnw119/data/vtps"
    convert_to_vtp(path, new_path)
